...
export const FormPreviewer = (props: IFormPreviewerProps) => {
  ...
  return (
    <div className="w-full overflow-y-auto bg-muted pb-8 sm:pt-8" ref={containerRef}>
      <FormBody
        className="relative mx-auto mb-12 flex w-full max-w-2xl flex-col overflow-hidden bg-background sm:rounded-[16px] sm:border sm:pb-10 sm:shadow-[0_10px_30px_-10px_rgba(0,0,0,0.1),0_5px_15px_-5px_rgba(0,0,0,0.05)]"
